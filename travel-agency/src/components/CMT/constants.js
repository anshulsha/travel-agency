...
const travellers = [
  ...
  { value: 7, label: "6+ travellers" },
];

const budget = [
  { value: 4000, label: "$4000 to $5000" },
  { value: 5000, label: "$5000 to $6000" },
  { value: 6000, label: "$6000 to $7000" },
  { value: 7000, label: "$7000 to $8000" },
  { value: 8000, label: "$8000 to $10000" },
  { value: 10000, label: "$10000 +" },
];

export { countries, interests, months, travellers, budget };
